...
<body>  
  ...
  <!-- Button -->   
  <br><button  onclick="filterCountries()">Filter</button></br>

<!-- Country dropdown -->
<br><select id="Countries List"></br>
  ...
  <script>
    function filterCountries() {
      ...
      for (let i = 0; i < options.length; i++) {
        ...
        options[i].style.display = country.includes(input) ? 'block' : 'none';
      }
    }
  </script>
